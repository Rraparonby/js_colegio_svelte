...
import NotaTableRowDataComp from '@/lib/proceso/nota/application/component/NotaTableRowDataComp.svelte';
...
const handleAction_ClickTableRowTableView = async (nota1: Nota) => {		
	...
	emit('handleAction_ClickTableRowView',nota1.detail);
};
