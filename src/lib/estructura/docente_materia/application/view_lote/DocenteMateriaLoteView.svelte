...
let titulo = 'Docente Materias Lote';
...
let id_new = 0;
let docente_materias_eliminar = new Array<DocenteMateria>();
...
const onClickRowTable = async (id:number) => {
    ...
    Object.assign(docente_materia,docente_materia2);
	
	docente_materia = docente_materia2;
...
const getTodosDatos = async () => {
    docente_materias = new Array<DocenteMateria>();
...
const eliminar = () => {	
    ...
    docente_materias = docente_materias2;
	...
	<div id="div_docente_materia_tabla_general">					
		...
		<table id="docente_materia_tabla_general" class="table_general">
			...
			<tbody>		
				...
				<tr on:click={event => onClickRowTable(docente_materia1.id)}>						
