...
import MateriaTableRowDataComp from '@/lib/estructura/materia/application/component/MateriaTableRowDataComp.svelte';
...
const handleAction_ClickTableRowTableView = async (materia1: Materia) => {		
	...
	emit('handleAction_ClickTableRowView',materia1.detail);
};
