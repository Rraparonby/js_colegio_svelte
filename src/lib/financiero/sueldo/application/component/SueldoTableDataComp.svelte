...
import SueldoTableRowDataComp from '@/lib/financiero/sueldo/application/component/SueldoTableRowDataComp.svelte';
...
const handleAction_ClickTableRowTableView = async (sueldo1: Sueldo) => {		
	...
	emit('handleAction_ClickTableRowView',sueldo1.detail);
};
